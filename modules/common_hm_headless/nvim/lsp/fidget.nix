...
{ nixvim, ... }:
let
  inherit (nixvim.lib.nixvim) mkRaw;
in
{
    ...
    settings = {
      ...
      progress = {
        ...
        display = {
          ...
          progress_ttl = mkRaw "math.huge"; # How long a message should persist when in progress
          progress_icon = {
            pattern = "dots";
            period = 1;
          ...
          format_group_name = mkRaw ''
            function (group) return tostring (group) end
          ''; # How to format a progress notification group's name
          overrides.rust_analyzer.name = "rust-analyzer"; # Override options from the default notification config
        };
      };
      notification = {
        ...
        '';
        configs.default = mkRaw "require('fidget.notification').default_config";
